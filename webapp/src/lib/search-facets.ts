...
export const SEARCH_FACETS: FacetDef[] = [
  ...
  { id: "li_people_crm", db: "linkedin", scope: "people", label: { en: "People in CRM", es: "Personas en el CRM" }, options: ["In CRM", "Not in CRM"] },
  { id: "li_interacted", db: "linkedin", scope: "people", label: { en: "People you interacted with", es: "Personas con las que interactuaste" }, options: ["Messaged", "Viewed", "Connected"] },
