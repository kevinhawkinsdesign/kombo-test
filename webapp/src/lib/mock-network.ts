...
export const introPaths: IntroPath[] = [
  {
    ...
    via: "Worked together at Criteo (2019–2021)",
    strength: "strong",
    source: "team",
  ...
  },
  {
    ...
    connectorTitle: "Demand Gen Lead · Talent Garden",
  ...
  },
  {
    ...
    connectorTitle: "Account Executive · Kombo",
    connectorAvatarColor: "#0ea5e9",
    via: "2nd-degree — mutual connection at Betterfly",
    strength: "weak",
    source: "team",
    connectorIsTeam: true,
  },
...
export const mcpConnections: McpConnection[] = [
  ...
  { id: "slack", name: "Softonic", description: "Post deal updates to your team channels.", category: "Messaging", connected: false, tools: ["post_message"] },
]
