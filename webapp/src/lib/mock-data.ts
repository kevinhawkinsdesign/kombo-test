...
export const conversations: Conversation[] = [
  ...
  // — WhatsApp, interested — thread continued off email after a call (1d ago) —
  {
    id: "c_13",
    prospectId: "p_5",
    channel: "whatsapp",
    subject: "Talent Garden — follow-up",
    unread: 1,
    lastMessageAt: "2026-06-22T16:12:00Z",
    status: "interested",
    aiDraft:
      "Perfect — I'll send the deck over here so it's all in one thread. Would Tuesday 10:00 CET work for the walkthrough with your demand-gen team?",
    messages: [
      {
        id: "m_25",
        channel: "whatsapp",
        direction: "outbound",
        body: "Priya — great speaking just now. Sending here as you suggested, easier than email on your side.",
      ...
      },
      {
        ...
        channel: "whatsapp",
        direction: "inbound",
        body: "Much easier, thanks! Can you drop the deck here too? I'll share it with the demand-gen team before we book time.",
        timestamp: "2026-06-22T16:12:00Z",
        read: false,
      },
    ],
  },
