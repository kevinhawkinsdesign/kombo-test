...
// Manual-task Start Time options — same fixed hour-of-day roster as the
// extension's taskStartTimeOptions (NotesHandler.constants.ts), value is the
// 24-hour clock hour.
export const TASK_START_TIME_OPTIONS = [
...
// Manual-task reminder-before options, in minutes — same fixed roster as the
// extension's taskReminderOptions.
