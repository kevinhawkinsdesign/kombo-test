...
const COPY = {
  ...
  it: {
    listTitle: (n: number) => `Aggiungi ${n} a una lista`,
    moveTitle: (n: number) => `Sposta ${n} in una lista`,
    campaignTitle: (n: number) => `Aggiungi ${n} a una campagna`,
    listDesc: "Scegli una lista o creane una nuova per la selezione.",
    moveDesc: "Scegli una lista in cui spostare la selezione — verrà rimossa da questa lista.",
    campaignDesc: "Scegli una campagna — i prospect selezionati entrano nella sua lista.",
    ...
    movedToList: (n: number, l: string) => `Spostati ${n} in ${l}`,
    enrolledIn: (n: number, l: string) => `Aggiunti ${n} a ${l}`,
    noLists: "Ancora nessuna lista — digita un nome per crearne una.",
    noCampaigns: "Ancora nessuna campagna — digita un nome per crearne una.",
    addToListAction: "Aggiungi a lista",
    moveToListAction: "Sposta in lista",
    addToCampaignAction: "Aggiungi a campagna",
  },
  fr: {
    listTitle: (n: number) => `Ajouter ${n} à une liste`,
    moveTitle: (n: number) => `Déplacer ${n} vers une liste`,
    campaignTitle: (n: number) => `Ajouter ${n} à une campagne`,
    listDesc: "Choisissez une liste ou créez-en une nouvelle pour la sélection.",
    moveDesc: "Choisissez une liste vers laquelle déplacer la sélection — elle sera retirée de cette liste.",
    campaignDesc: "Choisissez une campagne — les prospects sélectionnés rejoignent sa liste.",
    ...
    movedToList: (n: number, l: string) => `${n} déplacé(s) vers ${l}`,
    enrolledIn: (n: number, l: string) => `${n} ajouté(s) à ${l}`,
    noLists: "Aucune liste pour l'instant — saisissez un nom pour en créer une.",
    noCampaigns: "Aucune campagne pour l'instant — saisissez un nom pour en créer une.",
    addToListAction: "Ajouter à une liste",
    moveToListAction: "Déplacer vers une liste",
    addToCampaignAction: "Ajouter à une campagne",
  },
  de: {
    listTitle: (n: number) => `${n} zu einer Liste hinzufügen`,
    moveTitle: (n: number) => `${n} in eine Liste verschieben`,
    campaignTitle: (n: number) => `${n} zu einer Kampagne hinzufügen`,
    listDesc: "Wähle eine Liste oder erstelle eine neue für die Auswahl.",
    moveDesc: "Wähle eine Liste, in die die Auswahl verschoben wird — sie wird aus dieser Liste entfernt.",
    campaignDesc: "Wähle eine Kampagne — die ausgewählten Prospects werden ihrer Liste hinzugefügt.",
    ...
    movedToList: (n: number, l: string) => `${n} zu ${l} verschoben`,
    enrolledIn: (n: number, l: string) => `${n} zu ${l} hinzugefügt`,
    noLists: "Noch keine Listen — gib einen Namen ein, um eine zu erstellen.",
    noCampaigns: "Noch keine Kampagnen — gib einen Namen ein, um eine zu erstellen.",
    addToListAction: "Zu Liste hinzufügen",
    moveToListAction: "In Liste verschieben",
    addToCampaignAction: "Zu Kampagne hinzufügen",
  },
  pt: {
    listTitle: (n: number) => `Adicionar ${n} a uma lista`,
    moveTitle: (n: number) => `Mover ${n} para uma lista`,
    campaignTitle: (n: number) => `Adicionar ${n} a uma campanha`,
    listDesc: "Escolha uma lista ou crie uma nova para a seleção.",
    moveDesc: "Escolha uma lista para onde mover a seleção — será removida desta lista.",
    campaignDesc: "Escolha uma campanha — os prospects selecionados entram na sua lista.",
    ...
    movedToList: (n: number, l: string) => `${n} movidos para ${l}`,
    enrolledIn: (n: number, l: string) => `${n} adicionados a ${l}`,
    noLists: "Ainda sem listas — escreva um nome para criar uma.",
    noCampaigns: "Ainda sem campanhas — escreva um nome para criar uma.",
    addToListAction: "Adicionar a lista",
    moveToListAction: "Mover para lista",
    addToCampaignAction: "Adicionar a campanha",
  },
  pt_BR: {
    listTitle: (n: number) => `Adicionar ${n} a uma lista`,
    moveTitle: (n: number) => `Mover ${n} para uma lista`,
    campaignTitle: (n: number) => `Adicionar ${n} a uma campanha`,
    listDesc: "Escolha uma lista ou crie uma nova para a seleção.",
    moveDesc: "Escolha uma lista para mover a seleção — ela será removida desta lista.",
    campaignDesc: "Escolha uma campanha — os prospects selecionados entram na lista dela.",
    searchLists: "Buscar listas…",
    ...
    movedToList: (n: number, l: string) => `${n} movidos para ${l}`,
    enrolledIn: (n: number, l: string) => `${n} adicionados a ${l}`,
    noLists: "Ainda não há listas — digite um nome para criar uma.",
    noCampaigns: "Ainda não há campanhas — digite um nome para criar uma.",
    addToListAction: "Adicionar à lista",
    moveToListAction: "Mover para lista",
    addToCampaignAction: "Adicionar à campanha",
  },
} as const
