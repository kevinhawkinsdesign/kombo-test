...
const COPY = {
  ...
  it: {
    ...
    customizeDescription: "Di' a Kai su cosa deve concentrarsi il riepilogo.",
  ...
  fr: {
    ...
    customizeDescription: "Indiquez à Kai sur quoi le résumé doit se concentrer.",
  ...
  de: {
    ...
    customizeDescription: "Sag Kai, worauf sich die Zusammenfassung konzentrieren soll.",
  ...
  pt: {
    ...
    customizeDescription: "Diz ao Kai em que se deve focar o resumo.",
  ...
  pt_BR: {
    ...
    customize: "Personalizar",
    customizeTitle: "Personalizar resumo com IA",
    customizeDescription: "Diga ao Kai no que o resumo deve focar.",
