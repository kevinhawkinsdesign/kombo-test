...
const COPY = {
  ...
  it: {
    seqTitle: "Parti da una sequenza collaudata",
    seqSubtitle: "Giocate multicanale collaudate sul campo — usane una così com'è o modificala.",
    tmplTitle: "Parti da un modello collaudato",
    tmplSubtitle: "Modelli per email e LinkedIn con variabili, pronti da inviare.",
    use: "Usa",
    steps: (n: number) => `${n} passaggi`,
    seqAdded: (name: string) => `“${name}” aggiunta alle tue sequenze`,
    tmplAdded: (name: string) => `“${name}” aggiunto ai tuoi modelli`,
    dismiss: "Ignora",
  },
  fr: {
    seqTitle: "Partez d'une séquence éprouvée",
    seqSubtitle: "Des séquences multicanales qui ont fait leurs preuves — utilisez-les telles quelles ou adaptez-les.",
    tmplTitle: "Partez d'un modèle éprouvé",
    tmplSubtitle: "Modèles e-mail et LinkedIn avec variables, prêts à envoyer.",
    use: "Utiliser",
    steps: (n: number) => `${n} étapes`,
    seqAdded: (name: string) => `« ${name} » ajoutée à vos séquences`,
    tmplAdded: (name: string) => `« ${name} » ajouté à vos modèles`,
    dismiss: "Ignorer",
  },
  de: {
    seqTitle: "Starte mit einer bewährten Sequenz",
    seqSubtitle: "Praxiserprobte Multichannel-Playbooks — nutze sie direkt oder passe sie an.",
    tmplTitle: "Starte mit einer bewährten Vorlage",
    tmplSubtitle: "E-Mail- und LinkedIn-Vorlagen mit Variablen, bereit zum Versenden.",
    use: "Verwenden",
    steps: (n: number) => `${n} Schritte`,
    seqAdded: (name: string) => `„${name}“ zu deinen Sequenzen hinzugefügt`,
    tmplAdded: (name: string) => `„${name}“ zu deinen Vorlagen hinzugefügt`,
    dismiss: "Ausblenden",
  },
  pt: {
    seqTitle: "Comece com uma sequência comprovada",
    seqSubtitle: "Jogadas multicanal comprovadas — use uma tal como está ou ajuste-a.",
    tmplTitle: "Comece com um modelo comprovado",
    tmplSubtitle: "Modelos de email e LinkedIn com variáveis, prontos a enviar.",
    use: "Usar",
    steps: (n: number) => `${n} passos`,
    seqAdded: (name: string) => `“${name}” adicionada às suas sequências`,
    tmplAdded: (name: string) => `“${name}” adicionado aos seus modelos`,
    dismiss: "Dispensar",
  },
  pt_BR: {
    seqTitle: "Comece com uma sequência comprovada",
    seqSubtitle: "Jogadas multicanal comprovadas — use uma como está ou ajuste do seu jeito.",
    tmplTitle: "Comece com um modelo comprovado",
    tmplSubtitle: "Modelos de e-mail e LinkedIn com variáveis, prontos para enviar.",
    use: "Usar",
    steps: (n: number) => `${n} etapas`,
    seqAdded: (name: string) => `“${name}” adicionada às suas sequências`,
    tmplAdded: (name: string) => `“${name}” adicionado aos seus modelos`,
    dismiss: "Dispensar",
  },
