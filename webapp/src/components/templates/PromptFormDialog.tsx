...
const COPY = {
  ...
  it: {
    titleNew: "Nuovo modello di prompt",
    titleEdit: "Modifica modello di prompt",
    description:
      "Descrivi il messaggio una sola volta — l'IA scrive una versione unica per ogni destinatario.",
    nameLabel: "Nome",
    namePlaceholder: "es. Intro a freddo — punto dolente",
    channelLabel: "Canale",
    promptLabel: "Prompt",
    promptPlaceholder:
    ...
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Inizia a digitare un prompt per vedere messaggi di esempio.",
  ...
  fr: {
    titleNew: "Nouveau modèle de prompt",
    titleEdit: "Modifier le modèle de prompt",
    description:
      "Décrivez le message une seule fois — l'IA rédige une version unique pour chaque destinataire.",
    nameLabel: "Nom",
    namePlaceholder: "ex. Intro à froid — point de douleur",
    channelLabel: "Canal",
    promptLabel: "Prompt",
    promptPlaceholder:
    ...
    previewTitle: "Aperçu",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Commencez à saisir un prompt pour voir des exemples de messages.",
  ...
  de: {
    titleNew: "Neue Prompt-Vorlage",
    titleEdit: "Prompt-Vorlage bearbeiten",
    description:
      "Beschreibe die Nachricht einmal — die KI schreibt für jeden Empfänger eine einzigartige Version.",
    nameLabel: "Name",
    namePlaceholder: "z. B. Kaltakquise-Intro — Problem",
    channelLabel: "Kanal",
    promptLabel: "Prompt",
    promptPlaceholder:
    ...
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Beginne, einen Prompt einzugeben, um Beispielnachrichten zu sehen.",
    refresh: "Neues Beispiel",
    subject: "Betreff",
    cancel: "Abbrechen",
    create: "Prompt erstellen",
    save: "Speichern",
    created: "Prompt erstellt",
  ...
  pt: {
    titleNew: "Novo modelo de prompt",
    titleEdit: "Editar modelo de prompt",
    description:
      "Descreva a mensagem uma vez — a IA escreve uma versão única para cada destinatário.",
    nameLabel: "Nome",
    namePlaceholder: "ex.: Intro a frio — ponto de dor",
    channelLabel: "Canal",
    promptLabel: "Prompt",
    promptPlaceholder:
    ...
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Comece a escrever um prompt para ver mensagens de exemplo.",
  ...
  pt_BR: {
    ...
    description:
      "Descreva a mensagem uma vez — a IA escreve uma versão única para cada destinatário.",
    nameLabel: "Nome",
    namePlaceholder: "ex.: Introdução fria — ponto de dor",
    channelLabel: "Canal",
    promptLabel: "Prompt",
    promptPlaceholder:
    ...
    previewTitle: "Pré-visualização",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Comece a digitar um prompt para ver mensagens de exemplo.",
    refresh: "Novo exemplo",
    subject: "Assunto",
    cancel: "Cancelar",
    create: "Criar prompt",
