...
const COPY = {
  ...
  it: {
    title: "Scrivere con un prompt",
    description:
      "Scegli un prompt salvato o scrivine uno tuo — l'IA scrive un messaggio unico per ogni destinatario.",
    customOption: "Prompt personalizzato",
    customCaption: "Scrivi un'istruzione una tantum",
    customPlaceholder:
      "es. Scrivi una breve email a freddo che apre con un probabile punto dolente per il team di {{first_name}} in {{company}}…",
    channelLabel: "Canale",
    savedLabel: "Prompt salvati",
    empty: "Ancora nessun prompt salvato — creali nella pagina Modelli.",
    previewTitle: "Anteprima",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Scegli un prompt (o scrivine uno) per vedere messaggi di esempio.",
    previewNote: "Ogni destinatario riceve la propria versione scritta dall'IA.",
  ...
  fr: {
    title: "Écrire avec un prompt",
    description:
      "Choisissez un prompt enregistré ou écrivez le vôtre — l'IA rédige un message unique pour chaque destinataire.",
    customOption: "Prompt personnalisé",
    customCaption: "Écrivez une instruction ponctuelle",
    customPlaceholder:
    ...
    channelLabel: "Canal",
    savedLabel: "Prompts enregistrés",
    empty: "Aucun prompt enregistré pour l'instant — créez-en sur la page Modèles.",
    previewTitle: "Aperçu",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Choisissez un prompt (ou écrivez-en un) pour voir des exemples de messages.",
    previewNote: "Chaque destinataire reçoit sa propre version rédigée par l'IA.",
  ...
  de: {
    title: "Mit einem Prompt schreiben",
    description:
      "Wähle einen gespeicherten Prompt oder schreib deinen eigenen — die KI verfasst für jeden Empfänger eine einzigartige Nachricht.",
    customOption: "Individueller Prompt",
    customCaption: "Schreib eine einmalige Anweisung",
    customPlaceholder:
    ...
    channelLabel: "Kanal",
    savedLabel: "Gespeicherte Prompts",
    empty: "Noch keine gespeicherten Prompts — erstelle sie auf der Vorlagen-Seite.",
    previewTitle: "Vorschau",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Wähle einen Prompt (oder schreib einen), um Beispielnachrichten zu sehen.",
    previewNote: "Jeder Empfänger erhält seine eigene, von der KI geschriebene Version.",
  ...
  pt: {
    title: "Escrever com um prompt",
    description:
      "Escolha um prompt guardado ou escreva o seu — a IA redige uma mensagem única para cada destinatário.",
    customOption: "Prompt personalizado",
    customCaption: "Escreva uma instrução pontual",
    customPlaceholder:
      "ex.: Escreva um email de prospeção curto que comece com um ponto de dor provável da equipa de {{first_name}} na {{company}}…",
    channelLabel: "Canal",
    savedLabel: "Prompts guardados",
    empty: "Ainda não há prompts guardados — crie-os na página Modelos.",
    previewTitle: "Pré-visualização",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Escolha um prompt (ou escreva um) para ver mensagens de exemplo.",
    previewNote: "Cada destinatário recebe a sua própria versão escrita pela IA.",
  ...
  pt_BR: {
    title: "Escrever com um prompt",
    description:
      "Escolha um prompt salvo ou escreva o seu — a IA escreve uma mensagem única para cada destinatário.",
    customOption: "Prompt personalizado",
    customCaption: "Escreva uma instrução pontual",
    customPlaceholder:
      "ex.: Escreva um e-mail de prospecção curto que comece com um ponto de dor provável da equipe de {{first_name}} na {{company}}…",
    channelLabel: "Canal",
    savedLabel: "Prompts salvos",
    empty: "Ainda não há prompts salvos — crie-os na página Modelos.",
    previewTitle: "Pré-visualização",
    previewFor: (name: string, company: string) => `${name} @ ${company}`,
    previewEmpty: "Escolha um prompt (ou escreva um) para ver mensagens de exemplo.",
    previewNote: "Cada destinatário recebe sua própria versão escrita pela IA.",
    refresh: "Novo exemplo",
    subject: "Assunto",
    cancel: "Cancelar",
    insert: "Usar este prompt",
