...
const COPY = {
  ...
  it: {
    title: "Oggi",
    description: "Ciò che richiede la tua attenzione ora.",
    tasks: "Le tue attività",
    activity: "Attività recente",
    viewAll: "Vedi tutto",
    allClear: "Tutto a posto — nessuna attività aperta 🎉",
    completed: (title: string) => `"${title}" completata`,
    edit: "Modifica attività",
  },
  fr: {
    title: "Aujourd'hui",
    description: "Ce qui nécessite votre attention maintenant.",
    tasks: "Vos tâches",
    activity: "Activité récente",
    viewAll: "Tout voir",
    allClear: "Tout est à jour — aucune tâche en attente 🎉",
    completed: (title: string) => `« ${title} » terminée`,
  ...
  de: {
    ...
    allClear: "Alles erledigt — keine offenen Aufgaben 🎉",
    completed: (title: string) => `„${title}“ abgeschlossen`,
    edit: "Aufgabe bearbeiten",
  },
  pt: {
    title: "Hoje",
    description: "O que precisa da tua atenção agora.",
    tasks: "As tuas tarefas",
    activity: "Atividade recente",
    viewAll: "Ver tudo",
    allClear: "Tudo em dia — sem tarefas pendentes 🎉",
  ...
  pt_BR: {
    ...
    activity: "Atividade recente",
    viewAll: "Ver tudo",
    allClear: "Tudo em dia — nenhuma tarefa pendente 🎉",
    completed: (title: string) => `"${title}" concluída`,
    edit: "Editar tarefa",
  },
} as const
