      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          fullScreen
            ...
            : "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] grid grid-cols-1 w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg outline outline-1 outline-border sm:max-w-lg",
          className
        )}
        {...props}
      >
