...
const COPY = {
  ...
  it: {
    ...
    addContactToast: "Aggiungi un prospect a questa azienda",
    about: "Panoramica",
    buyingSignals: "Segnali d'acquisto",
    recentNews: "Notizie recenti",
    noNews: "Nessuna notizia recente per questo account.",
    openDeals: "Trattative aperte",
    dealName: "Nome trattativa",
    stage: "Fase",
    value: "Valore",
    closeDate: "Data di chiusura",
    noOpenDeals: "Nessuna trattativa aperta",
    contacts: "Prospect",
    noContacts: "Ancora nessun prospect — aggiungine qualcuno per iniziare.",
    keyExecutives: "Dirigenti chiave",
    firmographics: "Dati firmografici",
    industry: "Settore",
  ...
  fr: {
    ...
    addContactToast: "Ajouter un prospect à cette entreprise",
    about: "À propos",
    buyingSignals: "Signaux d'achat",
    recentNews: "Actualités récentes",
    noNews: "Aucune actualité récente pour ce compte.",
    openDeals: "Transactions ouvertes",
    dealName: "Nom de la transaction",
    stage: "Étape",
    value: "Valeur",
    closeDate: "Date de clôture",
    noOpenDeals: "Aucune transaction ouverte",
    contacts: "Prospects",
    noContacts: "Pas encore de prospects — ajoutez-en pour commencer.",
    keyExecutives: "Dirigeants clés",
    firmographics: "Données firmographiques",
    industry: "Secteur",
    employees: "Employés",
  ...
  de: {
    ...
    addContactToast: "Füge diesem Unternehmen einen Prospect hinzu",
    about: "Über",
    buyingSignals: "Kaufsignale",
    recentNews: "Aktuelle Nachrichten",
    noNews: "Keine aktuellen Nachrichten zu diesem Account.",
    openDeals: "Offene Deals",
    dealName: "Deal-Name",
    stage: "Phase",
    value: "Wert",
    closeDate: "Abschlussdatum",
    noOpenDeals: "Keine offenen Deals",
    contacts: "Prospects",
    noContacts: "Noch keine Prospects — füge welche hinzu, um loszulegen.",
    keyExecutives: "Wichtige Führungskräfte",
    firmographics: "Firmografische Daten",
    industry: "Branche",
  ...
  pt: {
    ...
    addContactToast: "Adicione um prospect a esta empresa",
    about: "Sobre",
    buyingSignals: "Sinais de compra",
    recentNews: "Notícias recentes",
    noNews: "Sem notícias recentes desta conta.",
    openDeals: "Negócios abertos",
    dealName: "Nome do negócio",
    stage: "Fase",
    value: "Valor",
    closeDate: "Data de fecho",
    noOpenDeals: "Sem negócios abertos",
    contacts: "Prospects",
    noContacts: "Ainda não há prospects — adicione alguns para começar.",
    keyExecutives: "Executivos-chave",
    firmographics: "Dados firmográficos",
    industry: "Setor",
    employees: "Colaboradores",
    revenue: "Receita",
    location: "Localização",
    accountOwner: "Responsável pela conta",
