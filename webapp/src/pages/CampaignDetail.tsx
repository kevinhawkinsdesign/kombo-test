...
const COPY = {
  en: {
    ...
    automationsDesc: "Let AI act on replies for you.",
    alertInterested: "Alert me when a reply is marked Interested",
    alertInterestedDesc:
      "Get a notification the moment AI classifies a reply as Interested.",
  ...
  es: {
    ...
    automationsDesc: "Deja que la IA actúe sobre las respuestas por ti.",
    alertInterested: "Avísame cuando una respuesta se marque como Interesado",
    alertInterestedDesc:
      "Recibe una notificación en cuanto la IA clasifique una respuesta como Interesado.",
  ...
  it: {
    ...
    automationsDesc: "Lascia che l'IA agisca sulle risposte per te.",
    alertInterested: "Avvisami quando una risposta viene marcata come Interessato",
    alertInterestedDesc:
      "Ricevi una notifica non appena l'IA classifica una risposta come Interessato.",
  ...
  fr: {
    ...
    automationsDesc: "Laissez l'IA agir sur les réponses à votre place.",
    alertInterested: "M'alerter quand une réponse est marquée Intéressé",
    alertInterestedDesc:
      "Recevez une notification dès que l'IA classe une réponse comme Intéressé.",
  ...
  de: {
    ...
    automationsDesc: "Lass die KI für dich auf Antworten reagieren.",
    alertInterested: "Benachrichtige mich, wenn eine Antwort als Interessiert markiert wird",
    alertInterestedDesc:
      "Erhalte eine Benachrichtigung, sobald die KI eine Antwort als Interessiert einstuft.",
  ...
  pt: {
    ...
    automationsDesc: "Deixe que a IA atue sobre as respostas por si.",
    alertInterested: "Avisar-me quando uma resposta for marcada como Interessado",
    alertInterestedDesc:
      "Receba uma notificação assim que a IA classificar uma resposta como Interessado.",
  ...
  pt_BR: {
    ...
    automationsDesc: "Deixe a IA agir sobre as respostas por você.",
